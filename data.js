...
const ACTIVITIES = [
  // Istanbul
  { id: "ist-hagia", city: "Istanbul", icon: "🕌", type: "fun", cost: "$", title: "Hagia Sophia & Blue Mosque", desc: "The two icons of the old city, face to face across Sultanahmet square." },
  { id: "ist-topkapi", city: "Istanbul", icon: "👑", type: "fun", cost: "$$", title: "Topkapı Palace & Harem", desc: "Ottoman sultans' palace — courtyards, treasury and Bosphorus views." },
  { id: "ist-bazaar", city: "Istanbul", icon: "🛍️", type: "fun", cost: "$", title: "Grand Bazaar & Spice Bazaar", desc: "4,000 shops of lamps, carpets, tea and Turkish delight. Haggle gently." },
  { id: "ist-cruise", city: "Istanbul", icon: "⛴️", type: "both", cost: "$$", title: "Bosphorus sunset cruise", desc: "Glide between two continents as the skyline turns gold. The signature moment." },
  { id: "ist-hammam", city: "Istanbul", icon: "🛁", type: "relax", cost: "$$", title: "Historic Turkish hammam", desc: "A 16th-century bathhouse scrub + foam massage. Pure reset after the flights." },
  { id: "ist-cistern", city: "Istanbul", icon: "🏛️", type: "fun", cost: "$", title: "Basilica Cistern", desc: "Eerie underground forest of columns and Medusa heads. Cool and atmospheric." },
  { id: "ist-food", city: "Istanbul", icon: "🥙", type: "fun", cost: "$", title: "Kadıköy street-food tour", desc: "Ferry to the Asian side for the city's best eats away from the crowds." },
  { id: "ist-night", city: "Istanbul", icon: "🌃", type: "fun", cost: "$$", title: "Rooftop bars in Beyoğlu", desc: "Cocktails over the Golden Horn, live music and late-night energy." },

  // Cappadocia
  { id: "cap-balloon", city: "Cappadocia", icon: "🎈", type: "both", cost: "$$$", title: "Sunrise hot-air balloon", desc: "Hundreds of balloons over fairy chimneys at dawn. The bucket-list shot." },
  { id: "cap-cave", city: "Cappadocia", icon: "🪨", type: "relax", cost: "$$", title: "Cave hotel + valley sunset", desc: "Stay carved into the rock; watch Red Valley glow with a glass of wine." },
  { id: "cap-goreme", city: "Cappadocia", icon: "⛪", type: "fun", cost: "$", title: "Göreme Open-Air Museum", desc: "Cave churches with 1,000-year-old frescoes, a UNESCO site." },
  { id: "cap-atv", city: "Cappadocia", icon: "🏍️", type: "fun", cost: "$$", title: "ATV / horseback through valleys", desc: "Tear (or trot) through Love & Rose Valleys at golden hour." },
  { id: "cap-pottery", city: "Cappadocia", icon: "🏺", type: "fun", cost: "$", title: "Avanos pottery workshop", desc: "Throw a pot on a kick-wheel by the red Kızılırmak river." },

  // Coast (Antalya / Fethiye / Oludeniz)
  { id: "coast-lagoon", city: "Coast", icon: "🏖️", type: "relax", cost: "$", title: "Ölüdeniz Blue Lagoon day", desc: "That turquoise postcard beach — swim, float, do nothing well." },
  { id: "coast-paraglide", city: "Coast", icon: "🪂", type: "fun", cost: "$$$", title: "Paraglide off Babadağ", desc: "Run off a 1,900m mountain and soar over the lagoon. Adrenaline peak." },
  { id: "coast-boat", city: "Coast", icon: "⛵", type: "both", cost: "$$", title: "Gulet boat & 12 islands cruise", desc: "Wooden yacht, swim stops in hidden coves, lunch on deck." },
  { id: "coast-kaleici", city: "Coast", icon: "🍊", type: "relax", cost: "$", title: "Antalya old town (Kaleiçi)", desc: "Cobbled lanes, Roman harbour, orange trees and waterfront cafés." },
  { id: "coast-spa", city: "Coast", icon: "💆", type: "relax", cost: "$$", title: "Beach club & spa afternoon", desc: "Day bed, sea, and a massage. The 'relaxation' half of the trip, sorted." },
  { id: "coast-gorge", city: "Coast", icon: "🥾", type: "fun", cost: "$", title: "Saklıkent Gorge hike", desc: "Wade through an icy slot canyon between towering walls." },

  // Food & extras (region-flexible)
  { id: "x-cooking", city: "Anywhere", icon: "🍳", type: "both", cost: "$$", title: "Turkish cooking class", desc: "Roll your own gözleme and master mezze with a local family." },
  { id: "x-wine", city: "Cappadocia", icon: "🍷", type: "relax", cost: "$$", title: "Cappadocia wine tasting", desc: "Türkiye's oldest wine region — volcanic-soil reds in a cave cellar." },
  { id: "x-pamukkale", city: "Detour", icon: "♨️", type: "relax", cost: "$$", title: "Pamukkale thermal terraces", desc: "Wade the white travertine pools above ancient Hierapolis." },
  { id: "x-raki", city: "Anywhere", icon: "🍢", type: "fun", cost: "$$", title: "Meze & rakı dinner night", desc: "A long table of small plates and aniseed spirit — the Turkish way to dine." },
];

// ── Suggested skeleton itinerary (9 nights) ───────────────────────────────
const ITINERARY = [
  { day: "Days 1–4", city: "Istanbul", tag: "Arrive & explore", activityCities: ["Istanbul", "Anywhere"],
    blurb: "Meet in Istanbul, beat jet-lag with a hammam, then dive into the old city, bazaars and a Bosphorus cruise." },
  { day: "Days 4–6", city: "Cappadocia", tag: "Wonder", activityCities: ["Cappadocia"],
    blurb: "Short flight to a cave hotel. Sunrise balloon, valley rides and pottery before a vineyard sunset." },
  { day: "Days 6–9", city: "Coast", tag: "Relax", activityCities: ["Coast", "Detour"],
    blurb: "Fly to the Mediterranean for beach days, a gulet cruise and slow evenings in Antalya's old town." },
  { day: "Day 9–10", city: "Home", tag: "Fly out", activityCities: [],
